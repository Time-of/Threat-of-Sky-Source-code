...
/**
 * 작성자: 20181220 이성수
 * Final 드래곤 보스 몬스터의 이륙-착륙 공격 스킬입니다.
 */
public class BTTask_BossFinalDragonSkill_LiftLand : BT_NodeBase
{
	public BTTask_BossFinalDragonSkill_LiftLand(BT_ATree Tree) : base(Tree) { }
	...
	public override ENodeState Evaluate()
	{
		...
		AttachedTree.GetComponent<BossEnemy_FinalDragon>().TrySkill_LiftLand();
