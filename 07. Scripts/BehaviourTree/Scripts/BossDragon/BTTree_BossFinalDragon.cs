 ...
 * 드래곤 보스의 비헤이비어 트리입니다.
 */
public class BTTree_BossFinalDragon : BT_ATree
{
	...
	protected override BT_NodeBase SetupRootNode()
	{
		...
		{
			new BTTask_BossFinalDragonSkill_Roar(this),
			new BTTask_BossFinalDragonSkill_LiftLand(this),
			new BTTask_BossFinalDragonTryAtk(this),
