...
/**
 * 작성자: 20181220 이성수
 * 드래곤 보스 몬스터의 로어 스킬입니다.
 */
public class BTTask_BossDragonSkill_Roar : BT_NodeBase
{
	public BTTask_BossDragonSkill_Roar(BT_ATree Tree) : base(Tree) { }
	...
	public override ENodeState Evaluate()
	{
		...
		AttachedTree.GetComponent<BossEnemy_Dragon>().TrySkill_Roar();
